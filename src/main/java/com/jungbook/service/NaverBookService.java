...
import com.jungbook.domain.BookDTO;
...
public class NaverBookService {
    private static String clientID = "ekkbkuIFAYcDws2u9s_P";
    private static String clientSecret = "6LmhmggUw7";

    //display ==> 몇개 출력
    //start==>몇번쨰부터 (item)
    public List<BookDTO> searchBook(String keyword, int display, int start) throws UnsupportedEncodingException {
